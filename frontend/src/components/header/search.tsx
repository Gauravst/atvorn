...
export const SearchBar = ({
  ...
  return (
    ...
    >
      ...
      <kbd className="bg-muted pointer-events-none absolute right-[0.3rem] hidden h-6 items-center gap-1 rounded border px-1.5 font-mono text-[10px] font-medium opacity-100 select-none sm:flex">
